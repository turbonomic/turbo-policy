...
For more information about SLO Horizontal Scaling Policies see the official [Kubernetes Service Policies] documentation.

# Vertical Scaling Policies

For more infomation about Vertical Scaling Policies, see the official [Container Spec Policies] documentation.
